...
"""***
TRIED IMPLEMENTING THIS CURSOR FUNCTION AS SUGGESTED BY PROJECT REVIEWER...
BUT IT PRODUCED MANY ERRORS...
WILL SURELY WORKOUT function decorators & contextlib IN NEAR FUTURE..
THANKS... :D
***
@contextmanager
def get_cursor():
    ...
    try:
        ...
        print "Error connecting to Cursor in psql...."
    else:
        DB.commit()
    finally:
        a.close()
